...
int main() {
    MunitTest tests[] = {
        munit_test("/get_temperature_status", test_cold),
        munit_test("/get_temperature_status", test_hot),
        munit_test("/get_temperature_status", test_just_right),
        munit_test("/get_temperature_status", test_just_right2),
        munit_null_test,
    };
